function waitload(cr){
 ...
 export const contentTemp=function(createElement,vm){
        ...
        function infoTemp(infodata){
            const imgClass = ['jsimg','cssimg','htmlimg','htmlimg','htmlimg'];
            function createImg(tid){
                return createElement('div',{
                attrs:{
                    "class":imgClass[tid-1]
                }
                }); 
            }
              ...
              return createElement('div',{
                attrs:{
                 ...
                 createElement('div',[
                    ...
                    (vm.loginState)&&createElement('span',{
                    attrs:{
                        id:"editContent"
                    },
                    domProps:{
          ...
          },[createImg(infodata.itemId),createInfo(infodata)]); 
        }
  ...
  export const itemTemp=function(createElement,vm){
...
export const listTemp=function(createElement,vm){
 ...
 export const versionTemp=function(createElement,items){
